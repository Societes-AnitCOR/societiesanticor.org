 ...
 */
final class Version20200529165325 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company DROP address, CHANGE created_at created_at INT NOT NULL, CHANGE updated_at updated_at INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE company ADD address VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE created_at created_at INT DEFAULT 0 NOT NULL, CHANGE updated_at updated_at INT DEFAULT 0 NOT NULL');
